...
You need to read or write text data, possibly in different text encodings such
as ASCII, UTF-8, or UTF-16.
"""
...
print('Reading text file with universal newlines turned off')
...
print('Reading text file as ASCII with ignore error handling')
